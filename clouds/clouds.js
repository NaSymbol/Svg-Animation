...
//need to condense the functions into one with inputs being the stop start and times
function cloudMove2() {
clouds2.animate({transform:"translate(-815.17708,-487.18354)" },170000,function(){
...
function cloudMove3() {
clouds3.animate({transform:"translate(-842.42668,-475.73703)" },190000,function(){
clouds3.attr({transform:"translate(712.44087,-475.73703)"
})
});
}
...
function headMove(){
 head.animate({transform:'matrix(0.99714566,-0.07550193,0.07550193,0.99714566,-23.857532,31.676027)'},4000, function(){
    head.animate({transform:'matrix(0.99230385,0.1238268,-0.1238268,0.99230385,44.165258,-47.848673)'},4000);
 });

};

var id3 = setInterval(cloudMove,10000);
//var id4 = setInterval(cloudMove2,0);
//var id5 = setInterval(cloudMove3,0);
var id6 = setInterval(blink, (Math.round(Math.random()*10000 + 2000)));
var id7 = setInterval(headMove, 8000);
//var randomTest = Math.round(Math.random()*10000 + 2000);
